...
class ModApprovedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $subject = $service->getSubject('mod_approved', $locale);
        $body = $service->renderBody('mod_approved', $data, $locale);
