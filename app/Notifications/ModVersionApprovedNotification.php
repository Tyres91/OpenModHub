...
class ModVersionApprovedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $subject = $service->getSubject('version_approved', $locale);
        $body = $service->renderBody('version_approved', $data, $locale);
